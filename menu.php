      ...
      <div class="slider-item" style="background-image: url(images/bg_3.jpg);">
    		...
    		<div class="row no-gutters d-flex">
    			...
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
						...
						<a href="#" class="img" style="background-image: url(images/<?php echo $pizzaImagem[$i]; ?> );"></a>
						
						<div class="text p-4">
							
    						<h3><?php echo $pizzaTitulo[$i]; ?></h3>
							
    						<p><?php echo $pizzaDescri[$i]; ?></p>
    						<p class="price">
								<span>R$ <?php echo $pizzaValor[$i]; ?></span> 
								
								<a href="pizza.php?codigo=<?php echo $pizzaCodigo[$i]; 
    	...
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <p class="mt-5">Conheça nossos <?php echo count($pizzaCodigo);  ?> sabores diferentes de pizza.</p>
          </div>
        </div>
        ...
        <div class="row">
	    	...
	    	<div class="col-md-6">
				<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(images/<?php echo $pizzaImagem[$i]; ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span><?php echo $pizzaTitulo[$i]; ?></span></h3>
	        				<span class="price">R$ <?php echo number_format( $pizzaValor[$i] , 2 ); ?></span>
	        			</div>
	        			<div class="d-block">
	        				<p><?php echo $pizzaDescri[$i]; ?></p>
	        			</div>
